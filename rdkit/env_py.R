...
# character vector.
PYENV_INSTALL <- c("r-reticulate", "rdkit")
# The name of the RDKit module (in case it changes, which is highly unlikely)
PYENV_MODULE <- "rdkit"
...
# [OPTIONAL, REQUIRED FOR AUTOCONFIG] Set the main conda packages to install,
# depending on it to define its dependencies. This will be used if INSTALL_FROM
# = "conda"
# ------------------------------------------------------------------------------
CONDA_PACKAGE <- "r-reticulate rdkit"
...
# ------------------------------------------------------------------------------
INSTALL_FROM_FILE <- file.path("rdkit", "environment.yaml")
# ------------------------------------------------------------------------------
