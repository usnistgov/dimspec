/*==============================================================================
  Description:	Build a database to hold results for non-targeted analysis
                high-resolution accurate-mass mass spectrometry (NTA-HRAM-MS) 
                experiments.
  Status:			  Development
  ...
  Dependencies:	sqlite3 (https://sqlite.org/version3.html)
  Usage:			  Run this script from the terminal to build the schema. It is 
  				      recommended to run from the project directory as
  				
        					sqlite3 nist_nta_dev.sqlite
        					.read config/build.sql
  				
  Details:		  Build files are located in the "config" directory and local
