...
peaks.](assets/fig04-14_additional_peak_info.png "Figure 14. Additional information available for peak."){#fig04-14 width="300"}
...
-   Loading the entire project from the compliance script (i.e. MSMatch
    ...
    analysis. Use the function [`close_up_shop()`](#fn_def_close_up_shop)
...
-   If launching the app directly and using the default settings there
    ...
    server. To stop it, use the [`api_stop`](#fn_def_api_stop) function from
...
[`get_ums`](#fn_def_get_ums){target="_blank"} function for subsequent
analysis.
...
unknown compound
([`search_precursor`](#fn_def_search_precursor){target="_blank"} function)
...
([`search_all`](#fn_def_search_all){target="_blank"} function). The
[`search_precursor`](#fn_def_search_precursor){target="_blank"} function
...
[`search_precursor`](#fn_def_search_precursor){target="_blank"} function is
no different than the [`search_all`](#fn_def_search_all){target="_blank"}
function.
...
[`compare_ms`](#fn_def_compare_ms){target="_blank"} function, which uses the
...
[`bootstrap_compare_ms`](#fn_def_bootstrap_compare_ms){target="_blank"}
...
[`get_annotated_fragments`](#fn_def_get_annotated_fragments){target="_blank"}
