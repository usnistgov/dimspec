...
Settings](#msmatch-application-settings) for instructions on how to set default
...
-   After closing all connections, a hanging connection may be indicated
    ...
    -   If launching MSMatch with the compliance script, run
        [`close_up_shop()`](#fn_def_close_up_shop) again.
...
The Mass Spectral Match for Non-Targeted Analysis application
