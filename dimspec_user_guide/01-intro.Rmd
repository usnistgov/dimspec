...
-   [Benjamin J. Place](https://www.nist.gov/people/benjamin-place){target="_blank"} [![](assets/ORCIDiD_iconvector.svg)](https://orcid.org/0000-0003-0953-5215){target="_blank"} (PI, Organic Chemical Metrology Group)

-   [Jared M. Ragland](https://www.nist.gov/people/jared-ragland){target="_blank"} [![](assets/ORCIDiD_iconvector.svg)](https://orcid.org/0000-0002-8055-2432){target="_blank"} (co-PI, Chemical Informatics Group)

Additional members of NIST PFAS project team providing guidance, input, and testing for this project include

-   [Jessica L. Reiner](https://www.nist.gov/people/jessica-l-reiner){target="_blank"} [![](assets/ORCIDiD_iconvector.svg)](https://orcid.org/0000-0002-1419-6062){target="_blank"} (co-PI, Biochemical and Exposure Science Group)

-   [Alix Rodawa](https://www.nist.gov/people/alix-rodowa){target="_blank"} [![](assets/ORCIDiD_iconvector.svg)](https://orcid.org/0000-0002-2650-0981){target="_blank"} (Biochemical and Exposure Science Group)

-   [Katherine Peter](https://www.researchgate.net/profile/Katherine-Peter){target="_blank"} [![](assets/ORCIDiD_iconvector.svg)](https://orcid.org/0000-0001-7379-265X){target="_blank"} (Univ. of Washington)

-   [John Kucklick](https://www.nist.gov/people/john-kucklick){target="_blank"} (Group Leader, [Biochemical and Exposure Science Group](https://www.nist.gov/mml/csd/biochemical-and-exposure-science-group){target="_blank"})

-   [Catherine A. Rimmer](https://www.nist.gov/people/catherine-rimmer){target="_blank"} [![](assets/ORCIDiD_iconvector.svg)](https://orcid.org/0000-0001-6734-6629){target="_blank"} (Group Leader, [Organic Chemical Metrology Group](https://www.nist.gov/mml/csd/organic-chemical-metrology){target="_blank"})
