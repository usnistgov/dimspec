...
A full graphical representation of the entity relationship diagram is also provided. Click the "Entity Relationship Diagram" in the navigation bar to view it. Click [here](assets/ERD.png){target="_blank"} to open this this graphic in full resolution.
