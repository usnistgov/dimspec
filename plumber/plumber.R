...
function(compound_id = 1L,
  ...
  compound_id <- as.integer(peak_id)
  ms_data <- dbGetQuery(
    con,
...
#* @param search_ms:json Search object generated by other calls, primarily those created by the R function `create_search_ms` which relies on other paths and should be processed outside this server.
