...
**Figure 4**
![Figure 4. Dialogs to identify features of interest by upload (left) or manually by clicking the Add button (right).](../dimspec_user_guide/assets/fig04-03_FOI_input_dialogs.png "Figure 4. Dialogs to identify features of interest by upload (left) or manually by clicking the Add button (right)."){width="50%"}

---

**Figure 5**
![Figure 5. Manage the feature identification list (left) interactively by adding, editing, or removing features as needed (right) by selecting a row from the table and clicking the appropriate button.](../dimspec_user_guide/assets/fig04-04_FOI_list.png "Figure 5. Manage the feature identification list (left) interactively by adding, editing, or removing features as needed (right) by selecting a row from the table and clicking the appropriate button."){width="75%"}
