...
A more detailed user guide for converting the files is provided as another [quick guide](https://pages.nist.gov/dimspec/docs/docs/quick_guides/file_convert.pdf). This data format conversion step is the same as for the [MSQC application](#msqc).
