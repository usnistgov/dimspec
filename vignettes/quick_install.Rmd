...
*See the [DIMSpec User Guide](https://pages.nist.gov/dimspec/instructions.html#installation) for full instructions and how to use DIMSpec. These instructions are a summary of those found there.*
...
1. (Optional, advanced) Customize any settings for your implementation (see the Project Set Up section of the [DIMSpec User Guide](https://pages.nist.gov/dimspec/instructions.html#project-set-up))
...
More information on developing with DIMSpec is provided in the full [DIMSpec User Guide](https://pages.nist.gov/dimspec) or the [Quick Guide - Developing with DIMSpec](https://pages.nist.gov/dimspec/docs/quick_guides/quick_advanced.pdf)
