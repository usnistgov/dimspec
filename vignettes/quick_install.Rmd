...
If your needs require only the database itself and not the attached toolkit, the SQLite file may be downloaded directly from the [NIST Public Data Repository (this link is not yet active)](TODO LINK) and, along with the technical sections in the [DIMSpec User Guide](https://usnistgov.github.io/dimspec/docs/user_guide/technical-details.html#technical-details) and the data dictionary describing its schema (a JSON file located in the project directory), used by any platform able to interact with SQLite databases.
...
*See the [DIMSpec User Guide](https://usnistgov.github.io/dimspec/docs/user_guide/instructions.html#installation) for full instructions and how to use DIMSpec. These instructions are a summary of those found there.*

1. Install software requirements for your operating system

   -   R v4.1 or later ([download](https://cran.r-project.org/))
   -   RTools (optional but may be required for package installation on Windows) ([download](https://cran.r-project.org/bin/windows/Rtools/))
   -   RStudio (optional but recommended) ([download](https://www.rstudio.com/products/rstudio/download/#download))
   -   SQLite3 ([download](https://www.sqlite.com/download.html)) and its command line interface ([download](https://www.sqlite.com/cli.html)) (both optional but recommended) 
   -   Git (optional but recommended) ([download](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git))
   -   A lightweight database interaction interface (e.g. DBeaver Lite ([download](https://dbeaver.com/download/lite/)) or similar) (suggested) 
...
1. (Optional, advanced) Customize any settings for your implementation (see the Project Set Up section of the [DIMSpec User Guide](https://usnistgov.github.io/dimspec/docs/user_guide/instructions.html#project-set-up))

1. Run the script at `/R/compliance.R` to establish the compute environment, which by default will:
...
More information on developing with DIMSpec is provided in the full [DIMSpec User Guide](https://usnistgov.github.io/dimspec/docs/user_guide) or the [Quick Guide - Developing with DIMSpec](https://usnistgov.github.io/dimspec/docs/quick_guides/quick_advanced.pdf)
