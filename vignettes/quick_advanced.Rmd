...
A logging table and normalization does exist but currently must be populated manually. It is recommended that developers take advantage of this but in no way is required. External logging of R functionality is discussed in the logger section.
...
### Plumber Application Programming Interface
...
See more details in the Plumber section of Technical Details in the [DIMSpec User Guide](TODO LINK) or the [DIMSpec Quick Guide - Plumber vignette](quick_plumber.Rmd).
