...
1. Using files produced in step 4, use the DIMSpec [Mass Spectral Quality Control (MSQC)](https://pages.nist.gov/dimspec/docs/dimspec_user_guide/msqc-home.html) web application [^1] to assess quality metrics for new data.
