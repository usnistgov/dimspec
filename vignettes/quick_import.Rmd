...
1. Convert raw data files to the mzML format ([see the quick guide for file conversions](https://pages.nist.gov/dimspec/docs/quick_guides/file_convert.pdf)).
...
1. Using files produced in step 4, use the [DIMSpec Quality Control (DIMSpec-QC)](https://pages.nist.gov/dimspec/docs/dimspec_user_guide/dimspec-qc-home.html) web application [^1] to assess quality metrics for new data.
