...
if (exists("fn_guide")) {
  message("\n\nHelp documentations for functions are available from the console using fn_help(X) where X is the name (quoted or unquoted) of a function in this project, or open indexed HTML function documentation using fn_guide()")
}
