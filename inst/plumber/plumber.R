...
#* @apiDescription This plumber API provides programmatic access to an SQLite database conforming to the <a href="https://github.com/usnistgov/dimspec">DIMSpec project</a>. See the <a href="https://pages.nist.gov/dimspec/docs">User Guide</a> describing the project, database, and this API for details. Endpoint definitions may be modified as needed to suit your project; this version supports generic endpoints and those necessary to run the web applications included with the full project. This version was created using <a href="https://www.rplumber.io">plumber</a> v1.1.0 and was last updated 2023-07-13.
#* @apiVersion 1.0.1.202306
